...
async function main() {
  ...
  console.log('\nEnabled collect modules: ', modules.collectModules.map(m => m.moduleName).join(', '));
  console.log('\nEnabled follow modules: ', modules.followModules.map(m => m.moduleName).join(', '));
  console.log('\nEnabled reference modules: ', modules.referenceModules.map(m => m.moduleName).join(', '));
